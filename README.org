...
which this package originally based on. Also, I would like to thank [[http://wingware.com][Wingware]],
...
This code uses a tight tolerance for the contraction mapping, and it minimizes
the GMM objective function to the correct minimum of =4.56=. (With BFGS, it
only needs 45 iterations).
